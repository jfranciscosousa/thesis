...
falar dos elementos de meta programaçao no hub (reflections e autoloading das Thing classes)

falar também daas comparaçoes e definiçoes em runtime nas triggered tasks
